parameter_list = ["PMRA", "PMDEC", "LAMBDA", "BETA", "PMLAMBDA", 
                  ...
                  "FD5", "DM", "DMX", "A1", "E", "T0", "PB", "OM", "OMDOT", "GAMMA", "PBDOT", 
                  "XPBDOT", "SINI", "MTOT", "M2", "XDOT", "DTHETA", "DR",  
                  "A1_2", "E_2", "PB_2", "OM_2", "T0_2", "PEPOCH", "START", "FINISH"]

spin_freq_derivatives = ["F1", "F2", "F3", "F4", "F5", "F6", "F7", "F8", "F9", "F10", "F11", 
                         "F12", "F13", "F14", "F15", "F16", "F17", "F18", "F19", "F20"]

string_list = ["PSR", "PSRJ", "RAJ", "DECJ", "SOLARN0", "EPHEM", "ECL", "CLK",
